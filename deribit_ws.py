...
class WS_Client(object):
    ...
    def buy(self, instrument_name, amount, order_type,
    ...
    def stop_buy(self, instrument_name, trigger, amount, order_type,
    ...
    def sell(self, instrument_name, amount, order_type,
            price=None, post_only=None):
        options = {
            "instrument_name" : instrument_name,
            "amount" : amount,
    ...
    def stop_sell(self, instrument_name, trigger, amount, order_type,
                 stop_price=None, price=None):
        options = {
            "trigger" : trigger,
            "instrument_name" : instrument_name,
